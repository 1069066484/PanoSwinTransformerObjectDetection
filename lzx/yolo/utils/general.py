...
from lzx.yolo.utils.downloads import gsutil_getsize
from lzx.yolo.utils.metrics import box_iou, fitness
from lzx.yolo.utils.torch_utils import init_torch_seeds
...
def scale_coords(img1_shape, coords, img0_shape, ratio_pad=None, right_pad=1):
    ...
    # print(gain, pad); input() # 0.25 [32.0, 112.0]
...
def non_max_suppression_pd2(prediction, conf_thres=0.25, iou_thres=0.45, classes=None, agnostic=False, multi_label=False,
                        labels=(), max_det=300):
    ...
    xc = [prediction_i[ ..., 4] > conf_thres for prediction_i in prediction]  # candidates
