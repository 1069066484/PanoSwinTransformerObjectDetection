...
class PanoRPNHead(RPNTestMixin, AnchorHead):
    """RPN head.
    ...
    def __init__(self, in_channels, **kwargs):
        super(PanoRPNHead, self).__init__(1, in_channels, **kwargs)
    ...
    def forward_single(self, x):
        ...
        # rpn_cls: Conv2d(256, 3, kernel_size=(1, 1), stride=(1, 1)), tells the existence of object
        # rpn_reg: Conv2d(256, 12, kernel_size=(1, 1), stride=(1, 1))
        rpn_cls_score = self.rpn_cls(x)
        # rpn_cls_score: 2x3x168x336
        rpn_bbox_pred = self.rpn_reg(x)
        # rpn_cls_score: 2x12x168x336
    ...
    def loss(self,
        ...
        """
        losses = super(PanoRPNHead, self).loss(
            cls_scores,
            bbox_preds,
            gt_bboxes,
            None,
