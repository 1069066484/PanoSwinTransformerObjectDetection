...
class AnchorHead(BaseDenseHead, BBoxTestMixin):
        ...
        Returns:
            tuple: A tuple of classification scores and bbox prediction.
                ...
                - bbox_preds (list[Tensor]): Box energies / deltas for all \
                    ...
                    is num_anchors * 4.
        """
        # feats: [2,256,168,336], [2,256,84,168], ...
    ...
    def _get_targets_single(self,
        ...
        # LZX notes: assigner MaxIoUAssigner
    ...
    def loss(self,
        ...
        if cls_reg_targets is None:
            return None
        # LZX notes: labels_list is rpn cls, consisting of only 0 and 1
        ...
        losses_cls, losses_bbox = multi_apply(
            self.loss_single,
            cls_scores, # RPN bin-cls
            bbox_preds, # RPN anchors
            all_anchor_list,
            labels_list,
            label_weights_list,
            bbox_targets_list,
